...
static TAutoConsoleVariable<int32> CVarClimbIKEnable(TEXT("movement.DisableClimbIK"), 0, TEXT("True to Disable Climb IK"));
...
FRigUnit_ClimbIK_Execute()
{
	...
	else
	{
		...
		//如果禁用IK，直接输出原始坐标
		if (CVarClimbIKEnable.GetValueOnGameThread() == 1 || ClimbIKControl == 0||MovingState==3)
		{
